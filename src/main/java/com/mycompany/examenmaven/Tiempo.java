...
public class Tiempo {
     ...
     * @param temperatura Es un objeto de tipo element que recoge el elemento
     * con la etiqueta indicada
     * @param pronostico Es un objeto de tipo element que recoge el elemento con
